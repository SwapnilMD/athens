...
var G__41868 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__41868,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__41868;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq41869){
var G__41870 = cljs.core.first(seq41869);
var seq41869__$1 = cljs.core.next(seq41869);
var G__41871 = cljs.core.first(seq41869__$1);
var seq41869__$2 = cljs.core.next(seq41869__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41870,G__41871,seq41869__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41874__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41874__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41874__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41873_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__41873_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41885 = cljs.core.get_global_hierarchy;
return (fexpr__41885.cljs$core$IFn$_invoke$arity$0 ? fexpr__41885.cljs$core$IFn$_invoke$arity$0() : fexpr__41885.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__41918 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__41918) : formatter_fn.call(null,G__41918));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__41919 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__41919) : formatter_fn.call(null,G__41919));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__41934 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__41934,"/"].join('');
} else {
return G__41934;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__41945 = exception.stack;
var G__41945__$1 = (((G__41945 == null))?null:clojure.string.split_lines(G__41945));
var G__41945__$2 = (((G__41945__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__41945__$1,depth));
if((G__41945__$2 == null)){
return null;
} else {
return clojure.string.trim(G__41945__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__41949 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41949,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41949,(1),null);
var vec__41952 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41952,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41952,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41952,(2),null);
...
var m__$1 = (function (){var G__41959 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__41966 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__41967 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__41967) : cljs.test.run_block.call(null,G__41967));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__41966) : obj.call(null,G__41966));
} else {
var G__42098 = (function (){var G__41977 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__41977);
} else {
return G__41977;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__41978,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__42012 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__42012) : f1.call(null,G__42012));
});
});
/**
...
var vec__42024 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42024,(0),null);
var types = vec__42024;
...
var G__42065 = type;
var G__42066 = new cljs.core.Keyword(null,"async","async",1050769601);
var fexpr__42064 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946),new cljs.core.Keyword("cljs.analyzer","analyzed","cljs.analyzer/analyzed",-735094162),true], null);
return (fexpr__42064.cljs$core$IFn$_invoke$arity$2 ? fexpr__42064.cljs$core$IFn$_invoke$arity$2(G__42065,G__42066) : fexpr__42064.call(null,G__42065,G__42066));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__42070){
var vec__42071 = p__42070;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42071,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42071,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__42074 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var G__42076 = (function (){
var seq__42077 = cljs.core.seq(vars__$1);
var chunk__42078 = null;
var count__42079 = (0);
var i__42080 = (0);
while(true){
if((i__42080 < count__42079)){
var v = chunk__42078.cljs$core$IIndexed$_nth$arity$2(null,i__42080);
var temp__5735__auto___42102 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42102)){
var t_42104 = temp__5735__auto___42102;
var G__42083_42105 = ((function (seq__42077,chunk__42078,count__42079,i__42080,t_42104,temp__5735__auto___42102,v,each_fixture_fn,G__42074,G__42074__$1,env,once_fixtures,each_fixtures,vec__42071,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42104)));
});})(seq__42077,chunk__42078,count__42079,i__42080,t_42104,temp__5735__auto___42102,v,each_fixture_fn,G__42074,G__42074__$1,env,once_fixtures,each_fixtures,vec__42071,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42083_42105) : each_fixture_fn.call(null,G__42083_42105));
} else {
}


var G__42107 = seq__42077;
var G__42108 = chunk__42078;
var G__42109 = count__42079;
var G__42110 = (i__42080 + (1));
seq__42077 = G__42107;
chunk__42078 = G__42108;
count__42079 = G__42109;
i__42080 = G__42110;
continue;
} else {
...
var G__42111 = cljs.core.chunk_rest(seq__42077__$1);
var G__42112 = c__4609__auto__;
var G__42113 = cljs.core.count(c__4609__auto__);
var G__42114 = (0);
seq__42077 = G__42111;
chunk__42078 = G__42112;
count__42079 = G__42113;
i__42080 = G__42114;
continue;
} else {
var v = cljs.core.first(seq__42077__$1);
var temp__5735__auto___42117__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___42117__$1)){
var t_42118 = temp__5735__auto___42117__$1;
var G__42084_42120 = ((function (seq__42077,chunk__42078,count__42079,i__42080,t_42118,temp__5735__auto___42117__$1,v,seq__42077__$1,temp__5735__auto__,each_fixture_fn,G__42074,G__42074__$1,env,once_fixtures,each_fixtures,vec__42071,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_42118)));
});})(seq__42077,chunk__42078,count__42079,i__42080,t_42118,temp__5735__auto___42117__$1,v,seq__42077__$1,temp__5735__auto__,each_fixture_fn,G__42074,G__42074__$1,env,once_fixtures,each_fixtures,vec__42071,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__42084_42120) : each_fixture_fn.call(null,G__42084_42120));
} else {
}


var G__42123 = cljs.core.next(seq__42077__$1);
var G__42124 = null;
var G__42125 = (0);
var G__42126 = (0);
seq__42077 = G__42123;
chunk__42078 = G__42124;
count__42079 = G__42125;
i__42080 = G__42126;
continue;
}
} else {
...
var fexpr__42075 = cljs.test.join_fixtures(once_fixtures);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42074__$1)].join('')));
