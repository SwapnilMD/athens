...
var G__46097 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46096;
acc = G__46097;
continue;
} else {
...
var G__46100 = cljs.core.nnext(opts__$1);
var G__46101 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46100;
acc = G__46101;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46104 = cljs.core.next(opts__$1);
var G__46105 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46104;
acc = G__46105;
continue;
} else {
...
return (function() { 
var G__46113__delegate = function (arg){
...
while (G__46115__i < G__46115__a.length) {G__46115__a[G__46115__i] = arguments[G__46115__i + 0]; ++G__46115__i;}
  arg = new cljs.core.IndexedSeq(G__46115__a,0,null);
} 
return G__46113__delegate.call(this,arg);};
G__46113.cljs$lang$maxFixedArity = 0;
G__46113.cljs$lang$applyTo = (function (arglist__46116){
var arg = cljs.core.seq(arglist__46116);
return G__46113__delegate(arg);
});
...
var G__46119 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46119;
continue;
} else {
...
var G__46121 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46121;
continue;
} else {
var G__46123 = clojure.zip.next(loc);
loc = G__46123;
continue;
