...
var G__46102 = cljs.core.next(opts__$1);
var G__46103 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46102;
acc = G__46103;
continue;
} else {
...
return (function() { 
var G__46118__delegate = function (arg){
...
return G__46118__delegate.call(this,arg);};
G__46118.cljs$lang$maxFixedArity = 0;
G__46118.cljs$lang$applyTo = (function (arglist__46124){
var arg = cljs.core.seq(arglist__46124);
return G__46118__delegate(arg);
});
...
var G__46125 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46125;
continue;
} else {
...
var G__46128 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46128;
continue;
} else {
var G__46130 = clojure.zip.next(loc);
loc = G__46130;
continue;
