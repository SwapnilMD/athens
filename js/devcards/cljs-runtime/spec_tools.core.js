...
var G__48327 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48327;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48361 = cljs.spec.alpha.get_spec(x);
x = G__48361;
continue;
} else {
