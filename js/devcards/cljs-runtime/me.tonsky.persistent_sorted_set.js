...
var pos_25104 = (0);
while(true){
var rest_25105 = (len - pos_25104);
if((rest_25105 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25104));
} else {
if((rest_25105 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25104,(pos_25104 + chunk_len)));

var G__25109 = (pos_25104 + chunk_len);
pos_25104 = G__25109;
continue;
} else {
var piece_len_25110 = (rest_25105 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25104,(pos_25104 + piece_len_25110)));

var G__25112 = (pos_25104 + piece_len_25110);
pos_25104 = G__25112;
continue;
