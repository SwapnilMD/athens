...
var temp__5733__auto___20702 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20702)){
var seen_errors_20705 = temp__5733__auto___20702;
if(cljs.core.truth_(seen_errors_20705.has(self))){
} else {
seen_errors_20705.add(self);

var temp__5735__auto___20707 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20707)){
var sense_20708 = temp__5735__auto___20707;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20708)].join(''));
} else {
}
}
} else {
